...
public class DouYuTaskAction implements ITaskAction {

	/*
	 * { "2018-12-19": [ 6, 6, 30, 98 ],
	 */
	private static final String jsonRootDir = "D:\\WebServer\\json\\";
	private static final String jsonPath = jsonRootDir + "douyu/douyu_pay.json";
	private static final String logPath = jsonRootDir + "douyu/douyu_pay.log";
