...
public class DaShengTaskAction implements ITaskAction {
	private static Logger log = Logger.getLogger(DaShengTaskAction.class);
	@Override
	public void handleTaskRequest(JSONObject request, JSONObject response) throws Exception {
		...
		boolean isInSocks5Devices = dev_tag.equals("phone000") || dev_tag.equals("phone111")
				|| dev_tag.equals("phone004") || dev_tag.equals("phone005") || dev_tag.equals("phone011")
				|| dev_tag.equals("phone012") || dev_tag.startsWith("P00")
				|| dev_tag.startsWith("A01")  || dev_tag.startsWith("A02") || dev_tag.startsWith("P01") || dev_tag.startsWith("P02")
				|| dev_tag.startsWith("P03");
		...
		try {
			...
			if (adtasks.length() > 0) {
				...
				if (dev_tag.startsWith("A00") || dev_tag.equals("A022")) {
