...
public class DouYuYouXiZhiJiaTaskAction implements ITaskAction {

	/*
	 * { "2018-12-19": [ 6, 6, 30, 98 ],
	 */
	private static final String jsonRootDir = "D:\\WebServer\\json\\";
	private static final String jsonPath = jsonRootDir + "douyu/DouYuYouXiZhiJia_pay.json";
	private static final String logPath = jsonRootDir + "douyu/DouYuYouXiZhiJia_pay.log";
	...
	@Override
	public void handleTaskReport(JSONObject request,JSONObject json) throws Exception {
	}
